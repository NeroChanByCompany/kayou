...
import com.nut.tripanalysis.app.form.QueryYesterdayAvgOilWearRankingForm;
...
@Slf4j
@RestController
public class QueryYesterdayAvgOilWearRankingController extends BaseController {

    @Autowired
    private RankingService rankingService;
    @LoginRequired
    @PostMapping("/queryYesterdayAvgOilWearRanking")
    public HttpCommandResultWithData businessHandle(@RequestJson QueryYesterdayAvgOilWearRankingForm command) {
        try {
            log.info("================queryYesterdayAvgOilWearRanking begin========================");
            this.formValidate(command);
            List<AvgOilwearRankingDto> result = rankingService.queryYesterdayOilWearRanking(command,true);
            log.info("================queryYesterdayAvgOilWearRanking end========================");
            ...
            if (e.getClass() == BusinessException.class) {
                ...
                e.printStackTrace();
                log.error("================queryYesterdayAvgOilWearRanking error========================");
