package com.nut.truckingteam.common.aop;
...
import com.nut.truckingteam.common.component.TokenComponent;
import com.nut.truckingteam.common.utils.ReqUtils;
...
public class LoginCheckAspect {
     ...
     * 定义切入点 就是需要拦截的切面
     */
    @Pointcut("execution(public * com.nut.truckingteam.app.controller.*.*(..))")
