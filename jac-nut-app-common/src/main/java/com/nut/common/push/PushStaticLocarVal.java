package com.nut.common.push;

/**
 * @Description: 推送静态方法 变量
 * @BelongsProject: jac-nut-app
 * @BelongsPackage: com.nut.locationstation.common.push
 * @Author: yzl
 * @CreateTime: 2021-06-22 13:06
 * @Version: 1.0
 */

public class PushStaticLocarVal {
     ...
     * 1通知：卡友圈消息
     */
    public static final String PUSH_TYPE_NOTICE_STYPE_FORUM= "40"; // 1通知：问卷调查
     ...
     * 卡友圈消息
     */
    public static final String MESSAGE_TYPE_FORUM = "8";
    /**
     * 卡友圈消息内容
     */
    public static final String MESSAGE_TYPE_FORUM_NAME="卡友圈消息";
    /**
     * 卡友圈消息
     */
    public static final String MESSAGE_TYPE_START_AND_STOP = "9";
    /**
     * 卡友圈消息内容
     */
    public static final String MESSAGE_TYPE_START_AND_STOP_NAME="车辆启停";
    /**
     * 卡友圈消息
     */
    public static final String MESSAGE_TYPE_FAULT = "10";
    /**
     * 卡友圈消息内容
     */
    public static final String MESSAGE_TYPE_FAULT_NAME="故障车辆";

    public static final String MESSAGE_TYPE_SIM_FLOW = "11";

    public static final String MESSAGE_TYPE_SIM_FLOW_NAME="流量消息";
