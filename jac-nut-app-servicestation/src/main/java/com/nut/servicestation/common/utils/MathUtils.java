...
public class MathUtils {
	 ...
	 * 人民币显示小数位
	 */
	public static final int DEF_CNY_SCALE = 10;
	/**
	 * 虚拟币显示小数位
	 */
	public static final int DEF_COIN_SCALE = 10;
	/**
	 * 手续费显示小数位
	 */
	public static final int DEF_FEE_SCALE = 8;
	/**
	 * 人民币输入小数位
	 */
	 ...
	 * 矿池虚拟币小数位
	 */
	public static final int DEF_POOL_SCALE = 10;
	/**
	 * 加法
	 * 
	 * @param a
