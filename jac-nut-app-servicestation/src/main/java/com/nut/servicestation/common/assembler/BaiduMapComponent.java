...
import com.nut.servicestation.app.form.DistanceTrueForm;
import com.nut.servicestation.common.pojo.BaiduMapServicePojo;
...
public class BaiduMapComponent {
     ...
     * @param lonEnd 终点经度
     */
    public JSONObject distance2point(String latStart, String lonStart, String latEnd, String lonEnd, String coordtype){
        String start = latStart+","+lonStart;
        String end = latEnd+","+lonEnd;
        String url = baiduMapUrl + "/directionlite/v1/driving?";
        url = url + "?output=json&tactics=0&coordtype="+coordtype + "&origin=" + start + "&destination=" + end;
        BaiduMapServicePojo baiduMapServicePojo = new BaiduMapServicePojo();
        baiduMapServicePojo.setMethod("get");
        baiduMapServicePojo.setUrl(url);
     ...
     * 计算实际距离
     */
    public JSONObject distanceTrue(JSONObject form){
        String url = baiduMapUrl + "/rectify/v1/track";
        BaiduMapServicePojo baiduMapServicePojo = new BaiduMapServicePojo();
        baiduMapServicePojo.setMethod("post");
        baiduMapServicePojo.setUrl(url);

        baiduMapServicePojo.setParams(form);
        return this.nutBaiduMapService(baiduMapServicePojo);
    }
    ...
    public JSONObject rectifyTrack(String project, JSONObject param) {
        String url = baiduMapUrl + "/rectify/v1/track";
        BaiduMapServicePojo baiduMapServicePojo = new BaiduMapServicePojo();
        baiduMapServicePojo.setMethod("post");
        baiduMapServicePojo.setUrl(url);
        baiduMapServicePojo.setProject(project);
        baiduMapServicePojo.setParams(param);
