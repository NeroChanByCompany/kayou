...
public class MathUtil {
    ...
    public static List<Float> scaleFloatList(List<Float> f, int newScale) {
        return f.stream().map(e -> e == null ? 0F : com.nut.servicestation.common.utils.MathUtil.scale(e, newScale).floatValue())
                .collect(Collectors.toList());
    }
    ...
    public static List<String> scaleStringList(List<String> s, int newScale) {
        return s.stream().map(e -> StringUtils.isBlank(e) ? "0" : com.nut.servicestation.common.utils.MathUtil.scale(e, newScale).toString())
                .collect(Collectors.toList());
    }
    ...
    public static List<Double> scaleDoubleList(List<Double> d, int newScale) {
        return d.stream().map(e -> e == null ? 0D : com.nut.servicestation.common.utils.MathUtil.scale(e, newScale).doubleValue())
                .collect(Collectors.toList());
    }
